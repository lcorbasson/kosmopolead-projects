ActionController::Routing::Routes.draw do |map|
  ...
  map.resources :projects,:member=>{:list_members=>:get},:collection=>{:refresh_menu=>:get,:add_version=>:get,:show_funding=>:get,:add=>:get,:settings=>:get, :edit_part_description => :get, :edit_part_synthesis => :get} do |project|
