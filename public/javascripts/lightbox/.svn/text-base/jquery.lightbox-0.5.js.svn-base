...
(function($) {
	...
	$.fn.lightBox = function(settings) {
		...
		settings = jQuery.extend({
			...
			imageLoading:			'/javascripts/lightbox/images/lightbox-ico-loading.gif',		// (string) Path and the name of the loading icon
			...
			imageBlank:				'/javascripts/lightbox/images/lightbox-blank.gif',			// (string) Path and the name of a blank image (one pixel)
